...
def game_turn(is_interactive=True):
    ...
    roll_again = True
    current_player = {'name': input("whats your name ? "), 'score': 0, 'lost_score': 0, 'nb_of_roll': 0, 'nb_of_turn': 0, 'nb_of_scoring_turn': 0, 'nb_of_non_scoring_turn': 0, 'nb_of_full_roll': 0}
